...
namespace Condominio_API.Migrations
{
    ...
    [Migration("20250720004253_AddCamposEntradaVisitanteManual")]
    partial class AddCamposEntradaVisitanteManual
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("condominio_API.Models.NotificacaoDestinatario", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("condominio_API.Models.Visitante", b =>
                {
                    ...
                    b.Property<bool>("PrestadorServico")
                        .HasColumnType("tinyint(1)");
            ...
            modelBuilder.Entity("condominio_API.Models.NotificacaoDestinatario", b =>
                {
                    ...
                    b.HasOne("condominio_API.Models.Usuario", "UsuarioDestino")
                        .WithMany()
